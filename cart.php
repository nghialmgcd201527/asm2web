    ...
    if (isset($_POST['action']) && $_POST['action']=="remove"){
        if(!empty($_SESSION["shopping_cart"])) {
            foreach($_SESSION["shopping_cart"] as $key => $value) {
		        ...
		        1 product has just been removed from the cart!</div>";
		    }
		    if(empty($_SESSION["shopping_cart"])){
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span>Total price:</span> <span><?php echo $total_price." VND"; ?></span></li>
                                <li><span>Delivery:</span> <span>Free</span></li>
                                <li><span>Total:</span> <span><?php echo $total_price." VND"; ?></span></li>
                            </ul>
                            <div class="cart-btn mt-100">
                                <a href="cart.php" class="btn amado-btn w-100">Payment</a>
                            </div>
                        </div>
                    </div>
                </div>
