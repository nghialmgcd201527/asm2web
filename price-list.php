                                      ...
                                      <!--PRICE CONTENT START-->
                                        <div class="generic_content clearfix">
                                            ...
                                            <div class="generic_feature_list">
                                              <ul>
                                                  <li><span>3 PRODUCTS</span> Each day</li>
                                                    <li><span>~50.000 VND</span> Shipping fee</li>
                                                    <li><span>No</span> Sales promotion</li>
                                                    <li><span>3 months</span> Insurance</li>
                                            ...
                                            <div class="generic_price_btn clearfix">
                                              <a class="" href="product.php?category=horror">BUY NOW</a>
                                            </div>
                                            <!--//BUTTON END-->
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <!--PRICE CONTENT START-->
                                        <div class="generic_content active clearfix">
                                            ...
                                            <div class="generic_feature_list">
                                              <ul>
                                                  <li><span>5 PRODUCTS</span> Each day</li>
                                                    <li><span>~20.000 VND</span> Shipping fee</li>
                                                    <li><span>Yes</span> Sales promotion</li>
                                                    <li><span>6 months</span> Insurance</li>
                                                    <li><span>24/7</span> Support</li>
                                                </ul>
                                            </div>
                                            <!--//FEATURE LIST END-->
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <!--PRICE CONTENT START-->
                                        <div class="generic_content clearfix">
                                            ...
                                            <div class="generic_feature_list">
                                              <ul>
                                                  <li><span>Unlimited PRODUCTS</span> Each day</li>
                                                    <li><span>Free</span> Shipping fee</li>
                                                    <li><span>Yes</span> Sales promotion</li>
                                                    <li><span>1 year</span> Insurance</li>
                                                    <li><span>24/7</span> Support</li>
                                                </ul>
                                            </div>
                                            <!--//FEATURE LIST END-->
