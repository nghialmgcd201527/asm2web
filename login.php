...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "You have not signed up yet!";
    } else{
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "You have not entered a password!";
    } else{
                    ...
                    <div class="col-lg-6 col-md-12 col-xs-12">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                <i class="fa fa-user" aria-hidden="true"> </i><label style="margin-left: 5px;">Username</label>
                                <input type="text" id="username" name="username" size=30 class="form-control"
                                    value="<?php echo $username; ?>">
                                <span class="help-block"><?php echo $username_err; ?></span>
                            </div>
                            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                <i class="fa fa-lock" aria-hidden="true"> </i><label style="margin-left: 5px;">Password</label>
                            ...
                            <p>What if you don't have an account? <a href="register.php" style="color: #fbb710; font-weight: bold;">Register now</a>.</p>
                        </form>
                    </div>
                    <div class="col-lg-6 col-md-12 col-xs-12">
